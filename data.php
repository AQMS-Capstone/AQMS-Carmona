...
<div class = "container">
  <br/>
      <div class="row">
              <div class="col-lg-4">
                <h2 class = "text-center sumports-header">Download Data</h2>
                <br/>
                  <div class = "row">
                      <div class="col-lg-4">
                ...
                <!--<p class = "text-center"><a class="btn btn-primary" href="#" role="button">Generate Data &raquo;</a></p>-->
              </div>
              <div class="col-lg-4">
                <h2 class = "text-center sumports-header">Generate Summary Reports</h2>
                <br/>
                  <div class = "row">
                      <div class="col-lg-4">
              ...
              <div class="col-lg-4">
                <h2 class = "text-center sumports-header">Visualize Data</h2>
                <br/>
                  <div class = "row">
                      <div class="col-lg-4">
