    ...
    <nav class="z-depth-1" style="height: 70px;">
        <div class="nav-wrapper">
            ...
            <ul class="side-nav" id="mobile-demo">
                ...
                <li><a id="calculator"><span class="material-icons">timeline</span>Calculators<i class="material-icons right" style="margin-left: 5px!important;">arrow_drop_down</i></a>
                </li>
