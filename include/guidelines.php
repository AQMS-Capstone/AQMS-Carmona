...
$co_step = 0.1;
$co_min = $co_guideline_values[0][0];
$co_max = $co_guideline_values[5][1];
$co_unit = "ppm";

$sulfur_step = 0.001;
$sulfur_min = $sufur_guideline_values[0][0];
$sulfur_max = $sufur_guideline_values[5][1];
$sulfur_unit = "ppm";
...
$o3_step = 0.001;
$o3_min = $ozone_guideline_values_8[0][0];
$o3_max = $ozone_guideline_values_1[5][1];
$o3_unit = "ppm";

$pm10_min = $pm_10_guideline_values[0][0];
$pm10_max = $pm_10_guideline_values[5][1];
$pm10_unit = "ug/m3";

$tsp_min = $tsp_guideline_values[0][0];
$tsp_unit = "ug/m3";
